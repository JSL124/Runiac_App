...
- **Sizing**: stone diameter is responsive within a 92–108px mobile range. The guide character fits inside its current stone, remaining legible without obscuring adjacent stages.
