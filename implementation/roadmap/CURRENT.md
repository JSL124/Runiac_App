...
- Current active capsule: None selected. Next work requires explicit future capsule selection.
...
- Current active milestone: No active capsule is selected. Phase 02 remains unselected, and the next gate is explicit future capsule selection only.
...
2. Active capsule document, if one is explicitly selected. No active capsule is currently selected.
...
Next gate is explicit selection of a future capsule. No active capsule is selected.

## Operational TODO / Active Capsule

Active capsule: None selected. Next capsule selection requires explicit routing.
...
8. Do not select or implement a next capsule, View Expert Plan/detail behavior, Phase 02 work, Firebase/backend/GPS/native/dependency work, or any new product scope without separate explicit approval.
