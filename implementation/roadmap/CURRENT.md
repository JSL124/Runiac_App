...
- Current active capsule: none selected. Latest locally closed capsule is `implementation/roadmap/capsules/adaptive-estimate-consumption.md`, completed on 2026-07-07 Asia/Singapore for Flutter owner-read/display consumption of backend-owned `adaptivePlanEstimates/{uid}` in generated planned-run distance estimate copy.
