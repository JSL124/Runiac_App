...
- Current active capsule: `implementation/roadmap/capsules/expert-plan-detail-static-snapshot-shell.md`, implemented locally, validated, and ready for commit. Do not treat it as closed until committed.
- Most recent completed capsule: `expert-plan-list-static-snapshot-shell` implemented, validated, and committed locally at `8111423de83369aec37425c1582897af9febdf59 feat(you): add expert plan list screen`.
...
- Current active milestone: `expert-plan-detail-static-snapshot-shell` is ready for commit after local validation. Phase 02 remains unselected.
...
2. Active capsule document: `implementation/roadmap/capsules/expert-plan-detail-static-snapshot-shell.md`.
...
Active capsule: `expert-plan-detail-static-snapshot-shell` ready for commit after local validation.
