...
- Current active capsule: none selected. Explicit next capsule selection is required before additional implementation.
...
- Current active milestone: no active capsule selected after closing `expert-plan-list-static-snapshot-shell`; explicit next capsule selection is required. Phase 02 remains unselected.
