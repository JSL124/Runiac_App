...
- Current active capsule: `implementation/roadmap/capsules/weekly-workout-detail-static-snapshot-shell.md`.
- Most recent completed capsule: `goal-plan-detail-static-snapshot-shell` implemented, validated, committed, pushed at `58a164d3daa1760524c74e6fdc6cdaa3457e5e26 feat(you): add static goal plan detail screen`, and hosted Governance CI #61 passed with run ID `27101828124`.
...
- Current active milestone: `weekly-workout-detail-static-snapshot-shell` is routed as the next static frontend-only You tab Weekly Workout Detail capsule; Phase 02 remains unselected.
...
2. Active capsule document: `implementation/roadmap/capsules/weekly-workout-detail-static-snapshot-shell.md`
...
Next gate is implementation of the selected `weekly-workout-detail-static-snapshot-shell` capsule only.

## Operational TODO / Active Capsule

Active capsule: `implementation/roadmap/capsules/weekly-workout-detail-static-snapshot-shell.md`.
...
3. Load `implementation/roadmap/capsules/weekly-workout-detail-static-snapshot-shell.md` before any implementation follow-up work; load `implementation/roadmap/capsules/goal-plan-detail-static-snapshot-shell.md` only when closure evidence is needed.
4. Treat the Goal Plan Detail capsule as closed unless a future explicit task reopens it.
...
8. For the selected capsule, future implementation is limited to static Flutter UI for the You > Plans Thu upcoming workout row and static Workout Detail / Edit schedule preview interaction only.
