...
- Current active capsule: `implementation/roadmap/capsules/home-maps-static-read-model-snapshot-readiness.md`.
- Most recent completed capsule: `home-maps-static-read-model-snapshot-readiness` implemented, validated, committed, pushed at `386d324 refactor(home-maps): isolate static display snapshots`, and hosted Governance CI passed.
...
- Current active milestone: Home / Maps static read-model snapshot readiness is implemented, validated, committed, pushed at `386d324 refactor(home-maps): isolate static display snapshots`, and hosted Governance CI passed; Phase 02 remains unselected.
...
2. Active capsule document: `implementation/roadmap/capsules/home-maps-static-read-model-snapshot-readiness.md`
...
- Maintain the scaffold baseline state only; the latest completed implementation approval was limited to the routed `home-maps-static-read-model-snapshot-readiness` static frontend-only Home / Maps presentation refactor capsule.
...
Active capsule: `implementation/roadmap/capsules/home-maps-static-read-model-snapshot-readiness.md`.
...
4. Treat the Home / Maps readiness capsule as closed unless a future explicit task reopens it.
