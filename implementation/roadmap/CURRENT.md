...
- Current active capsule: none; explicit next capsule selection is required.
...
- Current active milestone: `goal-plan-detail-static-snapshot-shell` is implemented, validated, committed, pushed at `58a164d3daa1760524c74e6fdc6cdaa3457e5e26 feat(you): add static goal plan detail screen`, and hosted Governance CI #61 passed with run ID `27101828124`; Phase 02 remains unselected and no next capsule is selected.
...
2. Active capsule document: none selected; load the most recent completed capsule only when closure evidence is needed: `implementation/roadmap/capsules/goal-plan-detail-static-snapshot-shell.md`
...
Next gate is explicit next capsule selection only; no next feature capsule is selected.

## Operational TODO / Active Capsule

Active capsule: none selected; explicit next capsule selection is required.
...
3. Load the selected capsule document before any follow-up work, or load `implementation/roadmap/capsules/goal-plan-detail-static-snapshot-shell.md` only when closure evidence is needed.
