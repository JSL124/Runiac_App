...
Active capsule: none selected. `implementation/roadmap/capsules/personalized-adaptive-estimate-learning.md` is complete locally after RED/GREEN Functions and Firestore rules evidence. The previous `implementation/roadmap/capsules/profile-persistence-rules-contract.md` capsule has been superseded locally by the profile edit/onboarding work. The previous `implementation/roadmap/capsules/firestore-base-bootstrap-seam.md` capsule is closed after the Firestore SDK/bootstrap seam sequence. The previously active `implementation/roadmap/capsules/complete-run-cloud-functions-emulator-skeleton.md` capsule is closed after the broader Run Tracking M2/M3/M5 sequence.
