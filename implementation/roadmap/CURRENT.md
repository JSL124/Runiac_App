...
- Current active milestone: none selected; explicit next capsule selection is required. Phase 02 remains unselected.
...
Next gate is explicit next capsule selection only.
...
8. No next feature capsule is selected; do not implement View Expert Plan, Phase 02 work, Firebase/backend/GPS/native/dependency work, or any new product scope without explicit future routing.
