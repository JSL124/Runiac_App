...
- Current active capsule: `implementation/roadmap/capsules/expert-plan-list-static-snapshot-shell.md`.
- Most recent completed capsule: `weekly-workout-detail-static-snapshot-shell` implemented, validated, and committed locally at `a6f7e7f8b0b977df06e60d33158d1c2421878c64 feat(you): add weekly workout detail screen` with polish commit `67f67534add890b97ee39cedfa358cdac7fe21a4 fix(you): refine weekly plan and schedule preview`.
...
- Current active milestone: `expert-plan-list-static-snapshot-shell` routed for roadmap/governance selection only; implementation has not started. Phase 02 remains unselected.
...
2. Active capsule document: `implementation/roadmap/capsules/expert-plan-list-static-snapshot-shell.md`
...
Next gate is separate implementation approval for the routed `expert-plan-list-static-snapshot-shell` static Flutter UI capsule.

## Operational TODO / Active Capsule

Active capsule: `implementation/roadmap/capsules/expert-plan-list-static-snapshot-shell.md`.
...
4. Treat the Goal Plan Detail and Weekly Workout Detail capsules as closed unless a future explicit task reopens either capsule.
...
8. `expert-plan-list-static-snapshot-shell` is selected for future static Flutter UI implementation only; do not implement it, View Expert Plan, Phase 02 work, Firebase/backend/GPS/native/dependency work, or any new product scope without separate implementation approval.
