...
- Last updated capsule: `implementation/roadmap/capsules/run-tab-fullscreen-map-overlay-alignment.md`
...
- Latest implementation completion target: `fix(mobile): align run tab map overlay layout`
