...
is_allowed_path() {
  case "$1" in
    ...
    docs/meta/REPOSITORY_WORKFLOW_RECORD.md|implementation/roadmap/capsules/repository-workflow-record.md|implementation/roadmap/capsules/flutter-app-shell-baseline.md|implementation/roadmap/capsules/android-ui-smoke-test-evidence.md|implementation/roadmap/capsules/home-dashboard-visual-polish.md|implementation/roadmap/capsules/premium-home-dashboard-static-wireframe-alignment.md|implementation/roadmap/capsules/github-actions-governance-ci-baseline.md|implementation/roadmap/capsules/github-actions-flutter-validation-baseline.md|implementation/roadmap/capsules/home-dashboard-scroll-layout-stability-fix.md|implementation/roadmap/capsules/home-dashboard-reference-layout-alignment.md|implementation/roadmap/capsules/home-dashboard-primary-action-simplification.md|implementation/roadmap/capsules/home-maps-static-read-model-snapshot-readiness.md|implementation/roadmap/capsules/goal-plan-detail-static-snapshot-shell.md|implementation/roadmap/capsules/maps-tab-static-placeholder.md|implementation/roadmap/capsules/maps-static-discovery-hierarchy-polish.md|implementation/roadmap/capsules/leaderboard-static-motivation-hierarchy-polish.md|implementation/roadmap/capsules/leaderboard-map-first-landing-shell.md|implementation/roadmap/capsules/leaderboard-help-modal-shell.md|implementation/roadmap/capsules/leaderboard-region-preview-sheet-shell.md|implementation/roadmap/capsules/leaderboard-leagues-popup-shell.md|implementation/roadmap/capsules/leaderboard-static-read-model-snapshot-readiness.md|implementation/roadmap/capsules/flutter-frontend-hygiene-cleanup.md|implementation/roadmap/capsules/flutter-source-structure-refactor.md|implementation/roadmap/capsules/run-tab-static-placeholder.md|implementation/roadmap/capsules/run-tab-fullscreen-map-overlay-alignment.md|implementation/roadmap/capsules/run-controls-and-plan-spacing-polish.md|implementation/roadmap/capsules/run-launch-fullscreen-static-interaction.md|implementation/roadmap/capsules/run-launch-brand-color-polish.md|implementation/roadmap/capsules/run-static-read-model-snapshot-readiness.md|implementation/roadmap/capsules/you-tab-progress-overview-static.md|implementation/roadmap/capsules/you-plans-static-ui.md)
      return 0
      ;;
