...
is_allowed_path() {
  case "$1" in
    ...
    docs/meta/REPOSITORY_WORKFLOW_RECORD.md|implementation/roadmap/capsules/repository-workflow-record.md|implementation/roadmap/capsules/flutter-app-shell-baseline.md|implementation/roadmap/capsules/android-ui-smoke-test-evidence.md|implementation/roadmap/capsules/home-dashboard-visual-polish.md|implementation/roadmap/capsules/premium-home-dashboard-static-wireframe-alignment.md|implementation/roadmap/capsules/github-actions-governance-ci-baseline.md|implementation/roadmap/capsules/home-dashboard-scroll-layout-stability-fix.md|implementation/roadmap/capsules/run-tab-static-placeholder.md|implementation/roadmap/capsules/run-tab-fullscreen-map-overlay-alignment.md)
      return 0
      ;;
