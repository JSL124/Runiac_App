  ...
  case "$1" in
    ...
    */build/*|build/*|*/.dart_tool/*|*.apk|*.aab|*.ipa|*.xcarchive)
    ...
    firebase/functions/*|firebase/functions/src/*)
      return 0
      ;;
    functions/.gitignore|functions/package-lock.json|functions/package.json|functions/tsconfig.json|functions/src/index.ts|functions/src/run/completeRun.ts|functions/src/run/runCompletionTypes.ts|functions/src/run/validateRunPayload.ts|functions/src/progression/progressionEventWriter.ts|functions/test/completeRun.test.ts|functions/test/completeRunZeroMetrics.test.ts|functions/test/completeRunCallableSurface.test.ts)
